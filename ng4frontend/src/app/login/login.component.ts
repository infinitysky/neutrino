...
export class LoginComponent implements OnInit {
    ...
    loginProcess(userLoginInfo: LoginInfo ){
      this.authenticationService.login( userLoginInfo)
        .subscribe(
          data => {
            this.tempData = data;
          },
          ...
          () => {
            if (this.tempData && this.tempData.data && this.tempData.status.toLowerCase() == 'success'){
              this._cookieService.addCookie('currentUser', JSON.stringify(this.tempData.data));
    ...
    loginStatusCheck(){
        ...
        // let currenUser = this._cookieService.getCookie('currentUser');
        // let currenTimeFrame = this._cookieService.getCookie('currentTimeFrame');
        // let currentLoginTime = this._cookieService.getCookie('currentLoginTime');
